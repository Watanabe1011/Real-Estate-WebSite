...
type FilterValuesProps = {
  ...
  rentFrequency?: string | string[] | undefined;
  categoryExternalID?: string | string[] | undefined;
  minPrice?: string | string[] | undefined;
  maxPrice?: string | string[] | undefined;
  areaMax?: string | string[] | undefined;
  roomsMin?: string | string[] | undefined;
  bathsMin?: string | string[] | undefined;
  sort?: string | string[] | undefined;
  locationExternalIDs?: string | string[] | undefined;
};

export const getFilterValues = (filterValues: FilterValuesProps) => {
  const {
    purpose,
    rentFrequency,
    categoryExternalID,
